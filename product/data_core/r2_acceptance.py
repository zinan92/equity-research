...
def _five_question_coverage(index: IndustryCompanyIndex, catalyst_profiles: Iterable[IndustryCatalystProfile], batch: Mapping[str, object]) -> dict[str, dict[str, object]]:
    ...
    return {
        ...
        "financial_delivery": {"covered": 0, "required": 20, "source": "missing_parsed_financial_evidence"},
...
def audit_r2(
    ...
    *,
    ...
    questions = _five_question_coverage(index, profiles, batch_receipt)
