...
_DATAFEED_METADATA = {
    ...
    "bitcoin": ("crypto", "datafeed:hyperliquid_perpetual_public", "price_crypto_perpetual"),
    "ethereum": ("crypto", "datafeed:hyperliquid_perpetual_public", "price_crypto_perpetual"),
