...
_CATALOG: dict[str, dict[str, Any]] = {
    "dxy": {"role": "全球储备货币与美元融资条件", "drivers": ["美国相对增长与实际利率", "联储政策与全球避险需求", "美元融资压力与资金回流"], "usual_consequences": ["美元走强通常收紧非美元资产的金融条件", "风险资产、黄金、加密资产与新兴市场可能承压，但美国增长驱动的美元上涨不必然压制股票"], "counter_case": "美元与风险资产可能同时上涨，例如美国增长预期改善且流动性仍充足时。"},
    ...
    "bitcoin": {"role": "高波动、流动性敏感的加密风险资产", "drivers": ["全球流动性与美元融资", "风险偏好和杠杆", "加密资产自身供需"], "usual_consequences": ["流动性收紧和美元走强通常压制高贝塔加密资产", "风险偏好恢复时反弹弹性通常较高"], "counter_case": "加密资产也可能受自身供需驱动而脱离传统风险资产。"},
...
def _validate_theory_text(text: str) -> None:
    ...
    numeric_free = re.sub(r"2s10s|10Y|2Y", "", text)
