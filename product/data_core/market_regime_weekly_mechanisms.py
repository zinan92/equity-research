...
_CATALOG: dict[str, dict[str, Any]] = {
    ...
    "bitcoin": {"role": "Hyperliquid BTC 可交易永续合约", "drivers": ["全球流动性与美元融资", "风险偏好和杠杆", "比特币自身供需"], "usual_consequences": ["流动性收紧和美元走强通常压制高贝塔加密资产", "风险偏好恢复时反弹弹性通常较高"], "counter_case": "加密资产也可能受自身供需驱动而脱离传统风险资产。"},
    "ethereum": {"role": "Hyperliquid ETH 可交易永续合约", "drivers": ["全球流动性与美元融资", "风险偏好和杠杆", "以太坊网络与生态供需"], "usual_consequences": ["风险偏好上升时 ETH 通常具有较高弹性", "美元走强或杠杆收缩时高贝塔加密资产通常承压"], "counter_case": "以太坊自身升级、链上活动或资金结构可能令其阶段性脱离 BTC。"},
