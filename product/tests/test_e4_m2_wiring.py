...
class M2WiringTest(unittest.TestCase):
 def test_receipted_input_changes_contract_without_policy_change(self):
  ...
  r=compile_vertical_degradation('300750.SZ',(f,),known_at='2026-07-29T00:00:00Z',additional_section_inputs={'executive_summary':{'market_snapshot':{'receipt_id':'m1'},'decision_summary':{'receipt_id':'m1'}}})
  s={x['section_id']:x for x in r['section_contract']['sections']};self.assertEqual(s['executive_summary']['status'],'full');self.assertEqual(r['degradation']['tier'],'B')
