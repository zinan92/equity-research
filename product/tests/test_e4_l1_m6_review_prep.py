...
class L1M6ReviewPrepTest(unittest.TestCase):
    def test_stale_legacy_is_not_counted_and_current_lineage_is_required(self) -> None:
        queue = {"data_kind": "real", "source_receipt_id": "r", "items": [{"judgment_id": "risk_register", "impact_rank": 2, "section_id": "risks_and_falsification", "review_status": "pending_human_review", "citations": [{"page_number": 8, "pdf_page_url": "https://official/a.pdf#page=8"}], "would_promote_section_to_full": True}]}
