...
class SellSideMatrixTest(unittest.TestCase):
    def test_compiles_page_verified_rating_and_preserves_missing_fields(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            result=compile_sell_side_matrices(bp,pp,runtime,as_of='2026-07-25'); row=result['matrices'][0]
    ...
    def test_rejects_lineage_mismatch_and_missing_rating(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            with self.assertRaisesRegex(ValueError,'lineage'): compile_sell_side_matrices(bp,pp,runtime,as_of='2026-07-25')
