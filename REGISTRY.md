...
- Start L2-B3 issue #35 from latest `main`: extract native text with OCR fallback into page-bound chunks and enforce document ID/page/raw-hash citation validation before publication.
- Version the parser for deterministic reruns, measure page-map and scanned-page text coverage, and mark table-location uncertainty explicitly.
- Keep automatic conclusion generation outside B3.
