...
- Request: `m1-g1:notification_channel:fbd101f1933b`
...
- Packet hash: `883de5d60724082689a31a4a7626effba056beb87595d04e62e077566c23d591`

## 需要明确回答的问题

1. 是否批准最多 20 名受邀用户的一对一风险卡发送，并明确禁止群发、公开链接和未同意触达？
2. 渠道允许的内容、频率、发送身份、退订方式、审计字段和保存期限是什么？
3. 能否在第一张外发卡之前验证单用户停止和全局停止开关？
4. 错误收件人或未授权披露时，如何立即停止、通知 owner、纠正并留下最小 receipt？
5. 批准覆盖的具体 channel identity、生效日、到期日和失效条件是什么？
