...
- Request: `m1-g1:personal_information_processing:fbd101f1933b`
...
- Packet hash: `d94e4ee6839d115ee3e1f1b2814cec8a0348f1004467acd57497f7a0534bb2de`

## 需要明确回答的问题

1. scope 中 ticker、组合权重、持有周期和用户风险规则的处理目的、最小必要性和法律基础是否成立？
2. 显式可撤回同意、人工最小访问、30 天保存、24 小时导出/删除是否足够？
3. 发送目的地、身份匹配、错误收件人、未授权披露和总停止开关还需哪些控制？
4. 可以保留哪些不含持仓正文的审计 receipt；删除、备份和事故通知如何执行？
5. 批准的司法辖区、用户范围、处理者/受托人、跨境边界、生效日和到期日是什么？
