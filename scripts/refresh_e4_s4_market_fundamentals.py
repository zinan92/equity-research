...
def main() -> None:
    ...
    parser.add_argument("--max-tickers", type=int, default=100); parser.add_argument("--delay", type=float, default=1.0); parser.add_argument("--collector-timeout", type=float, default=30.0)
    args=parser.parse_args()
    result=run_market_fundamentals_batch(args.identity_receipt,args.official_receipt,args.runtime_root,max_tickers=args.max_tickers,inter_ticker_delay_seconds=args.delay,collector_timeout_seconds=args.collector_timeout)
