...
def main():
 ...
 latest=max((str(x.get('report_period','')) for x in facts),default='unknown'); market_quote=next(x for x in m1['rows'] if x['ticker']=='300750.SZ')['market']['quote']; market_asof=market_quote.get('observed_at','unknown')
