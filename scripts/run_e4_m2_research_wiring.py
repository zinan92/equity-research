...
def main():
 ...
 for ticker in TARGETS:
  ...
  if governance:
   ...
   if gi.get('management_record',{}).get('status')=='available': inputs.setdefault('management_and_governance',{})['management_record']={'records':gi['management_record']['records'],'source_receipt':governance['receipt_id']}
   if gi.get('governance_events',{}).get('status')=='available': inputs.setdefault('management_and_governance',{})['governance_events']=gi['governance_events']['records']
