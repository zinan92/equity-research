...
if __name__ == "__main__":
    ...
    print(json.dumps(audit_r2(receipt, captures, repository_root=ROOT, financial_delivery_receipt=financial, falsifier_evidence_receipt=falsifier), ensure_ascii=False, sort_keys=True, indent=2))
